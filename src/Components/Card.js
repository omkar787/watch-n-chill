...
export default function Card({ movie }) {
    ...
    return (
        <div style={{ backgroundImage: `url(${process.env.REACT_APP_IMAGE_URI}/original${movie.poster_path})` }} className='cursor-pointer transition-all ease-in-out delay-150 hover:scale-105 bg-blue-200 flex flex-col justify-end shadow-xl shadow-gray-700  dark:shadow-gray-700 dark:bg-gray-800  dark:text-gray-300 w-screen bg-cover bg-no-repeat rounded-md md:w-96'>
